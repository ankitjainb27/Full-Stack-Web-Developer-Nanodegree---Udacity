...
restaurant1 = Restaurant(name="Urban Burger", restaurant_user_id=User1.user_id)

restaurant1.save()

menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
                     price="$7.50", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

menuItem1 = MenuItem(name="French Fries", description="with garlic and parmesan",
                     price="$2.99", course="Appetizer", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem1)
restaurant1.save()

menuItem2 = MenuItem(name="Chicken Burger", description="Juicy grilled chicken patty with tomato mayo and lettuce",
                     price="$5.50", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

menuItem3 = MenuItem(name="Chocolate Cake", description="fresh baked and served with ice cream",
                     price="$3.99", course="Dessert", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem3)
restaurant1.save()

menuItem4 = MenuItem(name="Sirloin Burger", description="Made with grade A beef",
                     price="$7.99", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem4)
restaurant1.save()

menuItem5 = MenuItem(name="Root Beer", description="16oz of refreshing goodness",
                     price="$1.99", course="Beverage", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem5)
restaurant1.save()

menuItem6 = MenuItem(name="Iced Tea", description="with Lemon",
                     price="$.99", course="Beverage", menu_user_id=User1.user_id)
restaurant1.menuitems.append(menuItem6)
restaurant1.save()

menuItem7 = MenuItem(name="Grilled Cheese Sandwich", description="On texas toast with American Cheese",
                     price="$3.49", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem7)
restaurant1.save()

menuItem8 = MenuItem(name="Veggie Burger", description="Made with freshest of ingredients and home grown spices",
                     price="$5.99", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem8)
restaurant1.save()

# Menu for Super Stir Fry
restaurant2 = Restaurant(name="Super Stir Fry", restaurant_user_id=User1.user_id)
...
restaurant2.menuitems.append(menuItem1)
restaurant2.save()
...
menuItem2 = MenuItem(
    ...
    price="$25", course="Entree", menu_user_id=User1.user_id)

restaurant2.menuitems.append(menuItem2)
restaurant2.save()

menuItem3 = MenuItem(name="Spicy Tuna Roll",
                     description="Seared rare ahi, avocado, edamame, cucumber with wasabi soy sauce ",
                     price="15", course="Entree", menu_user_id=User1.user_id)

restaurant2.menuitems.append(menuItem3)
restaurant2.save()

menuItem4 = MenuItem(name="Nepali Momo ", description="Steamed dumplings made with vegetables, spices and meat. ",
                     price="12", course="Entree", menu_user_id=User1.user_id)

restaurant2.menuitems.append(menuItem4)
restaurant2.save()
...
menuItem5 = MenuItem(name="Beef Noodle Soup",
                     ...
                     price="14", course="Entree", menu_user_id=User1.user_id)

restaurant2.menuitems.append(menuItem5)
restaurant2.save()
...
restaurant2.menuitems.append(menuItem6)
restaurant2.save()

# Menu for Panda Garden
restaurant1 = Restaurant(name="Panda Garden", restaurant_user_id=User1.user_id)
...
menuItem1 = MenuItem(name="Pho",
                     ...
                     price="$8.99", course="Entree", menu_user_id=User1.user_id)
...
menuItem2 = MenuItem(name="Chinese Dumplings",
                     ...
                     price="$6.99", course="Appetizer", menu_user_id=User1.user_id)
...
menuItem3 = MenuItem(name="Gyoza",
                     ...
                     price="$9.95", course="Entree", menu_user_id=User1.user_id)
...
menuItem4 = MenuItem(name="Stinky Tofu",
                     ...
                     price="$6.99", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem4)
restaurant1.save()

menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
                     price="$9.50", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

# Menu for Thyme for that
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine ", restaurant_user_id=User1.user_id)
...
menuItem1 = MenuItem(name="Tres Leches Cake",
                     ...
                     price="$2.99", course="Dessert", menu_user_id=User1.user_id)
...
menuItem3 = MenuItem(name="Honey Boba Shaved Snow",
                     ...
                     price="$4.50", course="Dessert", menu_user_id=User1.user_id)
...
menuItem4 = MenuItem(name="Cauliflower Manchurian",
                     ...
                     price="$6.95", course="Appetizer", menu_user_id=User1.user_id)
...
menuItem5 = MenuItem(name="Aloo Gobi Burrito",
                     ...
                     price="$7.95", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem5)
restaurant1.save()

menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
                     price="$6.80", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

# Menu for Tony's Bistro
restaurant1 = Restaurant(name="Tony\'s Bistro ", restaurant_user_id=User1.user_id)

restaurant1.save()

menuItem1 = MenuItem(name="Shellfish Tower",
                     description="Lobster, shrimp, sea snails, crawfish, stacked into a delicious tower",
                     price="$13.95", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem1)
restaurant1.save()

menuItem2 = MenuItem(name="Chicken and Rice", description="Chicken... and rice",
                     price="$4.95", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

menuItem3 = MenuItem(name="Mom's Spaghetti", description="Spaghetti with some incredible tomato sauce made by mom",
                     price="$6.95", course="Entree", menu_user_id=User1.user_id)
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", restaurant_user_id=User1.user_id)
...
menuItem3 = MenuItem(name="Potstickers", description="Delicious chicken and veggies encapsulated in fried dough.",
                     price="$6.50", course="Appetizer", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem3)
restaurant1.save()

menuItem4 = MenuItem(name="Nigiri Sampler", description="Maguro, Sake, Hamachi, Unagi, Uni, TORO!",
                     price="$6.75", course="Appetizer", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem4)
restaurant1.save()

menuItem2 = MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",
                     price="$7.00", course="Entree", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem2)
restaurant1.save()

# Menu for Auntie Ann's
restaurant1 = Restaurant(name="Auntie Ann\'s Diner' ", restaurant_user_id=User1.user_id)
...
restaurant1.menuitems.append(menuItem9)
restaurant1.save()
...
menuItem2 = MenuItem(name="Broiled salmon",
                     ...
                     price="$10.95", course="Entree", menu_user_id=User1.user_id)
...
menuItem3 = MenuItem(name="Morels on toast (seasonal)",
                     ...
                     price="$7.50", course="Appetizer", menu_user_id=User1.user_id)
...
menuItem4 = MenuItem(name="Tandoori Chicken",
                     ...
                     price="$8.95", course="Entree", menu_user_id=User1.user_id)
...
menuItem10 = MenuItem(name="Spinach Ice Cream", description="vanilla ice cream made with organic spinach leaves",
                      price="$1.99", course="Dessert", menu_user_id=User1.user_id)

restaurant1.menuitems.append(menuItem10)
restaurant1.save()

# Menu for Cocina Y Amor
restaurant1 = Restaurant(name="Cocina Y Amor ", restaurant_user_id=User1.user_id)

restaurant1.save()

menuItem1 = MenuItem(name="Super Burrito Al Pastor",
                     description="Marinated Pork, Rice, Beans, Avocado, Cilantro, Salsa, Tortilla",
                     price="$5.95", course="Entree", menu_user_id=User1.user_id)
...
restaurant1 = Restaurant(name="State Bird Provisions", restaurant_user_id=User1.user_id)
restaurant1.save()
...
menuItem1 = MenuItem(name="Chantrelle Toast",
                     ...
                     price="$5.95", course="Appetizer", menu_user_id=User1.user_id)
...
menuItem1 = MenuItem(name="Guanciale Chawanmushi",
                     ...
                     price="$6.95", course="Dessert", menu_user_id=User1.user_id)
...
menuItem1 = MenuItem(name="Lemon Curd Ice Cream Sandwich",
                     ...
                     price="$4.25", course="Dessert", menu_user_id=User1.user_id)
